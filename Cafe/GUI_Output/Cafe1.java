public class Cafe1 extends JFrame {
	...
	public Cafe1() {
		...
		pNorth.setBackground(new Color(203, 201, 164));
		...
		int price[] = { 3200, 3700, 4200, 4400, 3800, 4000, 4500, 4400 };			
		...
		for (int i = 0; i < menu.length; i++) {
			...
			icon[i] = new ImageIcon("C:\\Users\\82107\\Desktop\\program\\JAVA_SYUDY2\\Personal_Project\\src\\gui_test\\img\\" + (i+1) + ".jpg");
			bt[i].setIcon(icon[i]);
